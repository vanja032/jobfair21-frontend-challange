...
namespace Platformer.UI
{
    public class LevelCanvas : MonoBehaviour
    {
        ...
        void Awake()
        {
            ...
            this.gameObject.transform.Find("InGameUI").Find("Enemies").GetComponent<RectTransform>().anchoredPosition = new Vector2(-this.gameObject.transform.Find("InGameUI").Find("Enemies").GetComponent<RectTransform>().rect.height / 3 * 2 - this.gameObject.transform.Find("InGameUI").Find("Enemies").GetComponent<RectTransform>().rect.width * 2f , -this.gameObject.transform.Find("InGameUI").Find("Enemies").GetComponent<RectTransform>().rect.height);
